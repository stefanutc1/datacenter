...
| **SOC / SIEM (VLAN 30)** | `192.168.64.48/28` | Security Onion 3.2 (VM 217), Wazuh Manager, Splunk/Elastic forwarders, Sentinel connectors, Suricata/Snort IDS/IPS | Ingest ports open (3100, 1514, 443). Sigma rules, YARA signatures, MISP feeds. |
| **DFIR SANDBOX (VLAN 35)**| `192.168.64.64/28` | REMnux v7 / Noble (VM 218), Air-Gapped Malware Analysis & Forensics Lab | Volatility 3 (memory), Autopsy (disk), Ghidra, IDA Pro, x64dbg, Wireshark, tcpdump. |
...
- **SIEM & Log Pipelines**: Security Onion 3.2 (VM 217), Wazuh Manager 4.8, Splunk, Elastic (ELK), Microsoft Sentinel, Grafana Loki.
...
- **DFIR & Reverse Engineering**: REMnux v7 / Noble (VM 218), Autopsy, Volatility 3, Ghidra, IDA Pro, x64dbg.
