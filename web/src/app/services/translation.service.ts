...
const EN_TRANSLATIONS: Translations = {
  ...
  metricVirtDesc: 'Proxmox VE x86_64 hosting OPNsense, Windows Server AD, RHEL, OpenStack, cyber fleet (VM 200-207), Bachelor Thesis research lab (VM 300-301), and 75 LXC containers.',
