...
const TRANSLATIONS: Record<Language, Translations> = {
  ro: {
    ...
    metricVirtDesc: 'Proxmox VE x86_64 & ARM64 găzduind OPNsense, Windows AD, RHEL, BSD, Talos Linux K8s și cele 84 de microservicii active.',
    
    metricServicesTitle: 'SERVICII ACTIVE & MULTI-CLOUD',
    metricServicesCount: '84 Servicii · 3 Clouds',
    metricServicesDesc: '84 de microservicii active și mașini virtuale KVM/BSD integrate hibrid cu Azure Key Vault, GCP WORM GCS & AWS Glacier.',
    ...
    srvTitle: 'Servicii & Workload-uri Active (84)',
    srvDesc: 'Catalogul complet cu toate cele 84 de microservicii și componente de infrastructură cu capturi HD de interfață, telemetrie în timp real și alocare hardware.',
  ...
  en: {
    ...
    metricVirtDesc: 'Proxmox VE x86_64 & ARM64 hosting OPNsense, Windows AD, RHEL, BSD, Talos Linux K8s, and all 84 active microservices.',
    
    metricServicesTitle: 'ACTIVE SERVICES & MULTI-CLOUD',
    metricServicesCount: '84 Services · 3 Clouds',
    metricServicesDesc: '84 active on-prem microservices and KVM/BSD enterprise VMs federated with Azure Key Vault, GCP WORM Storage & AWS Glacier.',
    ...
    srvTitle: 'Active Services & Workloads (84)',
    srvDesc: 'Complete catalog of all 84 active homelab microservices and infrastructure components with dedicated HD screenshots, real-time telemetry, and hardware ceilings.',
