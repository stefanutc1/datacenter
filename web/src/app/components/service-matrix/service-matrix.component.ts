   ...
   <div class="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-8">
    <div class="space-y-2">
     ...
     <p class="text-sm text-slate-300 max-w-2xl font-sans font-normal leading-relaxed">
      {{ ts.isRomanian 
       ? 'Catalogul complet cu toate cele 84 de microservicii și componente de infrastructură. Fiecare serviciu include captură HD de interfață, telemetrie în timp real și alocare hardware.' 
       : 'Complete catalog of all 84 active homelab microservices and infrastructure components with dedicated HD screenshots, real-time telemetry, and hardware ceilings.' }}
     </p>
    </div>
