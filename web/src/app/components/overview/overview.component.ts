...
@Component({
  ...
  template: `
    <section class="w-full pt-12 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-b border-obsidian-750 font-sans">
      ...
      <!-- Top Tag (IBM Plex Mono) -->
      <div class="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-obsidian-850 border border-obsidian-700 text-xs font-mono text-emerald-400 mb-6">
        <span class="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
        <span class="tracking-wide">INFRASTRUCTURE ARCHITECTURE & DIGITAL TWIN</span>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 font-sans">
        ...
        <div class="p-5 rounded-2xl bg-obsidian-850/80 border border-obsidian-750 space-y-2 hover:border-obsidian-600 transition-colors shadow-lg">
          <div class="text-[11px] font-mono text-slate-400 uppercase tracking-wider">Physical Compute</div>
        ...
        <div class="p-5 rounded-2xl bg-obsidian-850/80 border border-obsidian-750 space-y-2 hover:border-obsidian-600 transition-colors shadow-lg">
          <div class="text-[11px] font-mono text-slate-400 uppercase tracking-wider">Virtualization</div>
        ...
        <div class="p-5 rounded-2xl bg-obsidian-850/80 border border-obsidian-750 space-y-2 hover:border-obsidian-600 transition-colors shadow-lg">
          <div class="text-[11px] font-mono text-slate-400 uppercase tracking-wider">Microservices</div>
        ...
        <div class="p-5 rounded-2xl bg-obsidian-850/80 border border-obsidian-750 space-y-2 hover:border-obsidian-600 transition-colors shadow-lg">
          <div class="text-[11px] font-mono text-slate-400 uppercase tracking-wider">Cyber & DFIR</div>
