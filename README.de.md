...
| **207** | `openindiana` | OpenIndiana Hipster | 2 Cores | 2.048 MB (2 GB) | **1.024 MB (1 GB)** | VirtIO SCSI Single + Solaris | Referenz-Enterprise-ZFS, Solaris-Zonen, Crossbow-VNICs, DTrace |
| **208** | `netbsd` | NetBSD 10.0 | 2 Cores | 1.024 MB (1 GB) | **512 MB** | VirtIO SCSI Single | Portables Unix-Referenzsystem, Rump Anykernel, pkgsrc |
| **209** | `nixos` | NixOS 24.11 | 2 Cores | 2.048 MB (2 GB) | **1.024 MB (1 GB)** | VirtIO SCSI Single | Deklaratives Linux, Flakes Reproduzierbare Builds, Atomare Rollbacks |
| **210** | `dragonflybsd` | DragonFly BSD 6.4 | 2 Cores | 2.048 MB (2 GB) | **1.024 MB (1 GB)** | VirtIO SCSI Single | HAMMER2 Journaling-Dateisystem, Hybrider Mikrokernel, Lockless SMP |
