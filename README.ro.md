...
| **208** | `netbsd` | NetBSD 10.0 | 2 Nuclee | 1.024 MB (1 GB) | **512 MB** | VirtIO SCSI Single | Referință Unix Portabil, Rump Anykernel, Pachetare pkgsrc |
| **209** | `nixos` | NixOS 24.11 | 2 Nuclee | 2.048 MB (2 GB) | **1.024 MB (1 GB)** | VirtIO SCSI Single | Linux Declarativ Imutabil, Build-uri Reproductibile Flakes, Rollback Atomic |
| **210** | `dragonflybsd` | DragonFly BSD 6.4 | 2 Nuclee | 2.048 MB (2 GB) | **1.024 MB (1 GB)** | VirtIO SCSI Single | Sistem de Fișiere Jurnalizat HAMMER2, Microkernel Hibrid, SMP Lockless |
