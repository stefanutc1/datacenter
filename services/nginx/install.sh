...
# Source:      https://community-scripts.org/scripts/nginx
...
APP_NAME="Nginx"
SCRIPT_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/nginx.sh"
SCRIPT_PAGE="https://community-scripts.org/scripts/nginx"
