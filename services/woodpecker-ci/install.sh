#!/usr/bin/env bash
# ---------------------------------------------------------------------------
# Service:     Woodpecker CI
# Description: Proxmox VE LXC install script from community-scripts.org
# Source:      https://community-scripts.org/scripts/woodpecker-ci
# Repository:  https://github.com/community-scripts/ProxmoxVE
# License:     MIT
# ---------------------------------------------------------------------------
# Usage:
#   Run directly on a Proxmox VE node:
#     bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/woodpecker-ci.sh)"
#
...
SCRIPT_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/woodpecker-ci.sh"
SCRIPT_PAGE="https://community-scripts.org/scripts/woodpecker-ci"
