...
# Source:      https://community-scripts.org/scripts/scrutiny
# Repository:  https://github.com/community-scripts/ProxmoxVE
# License:     MIT
# ---------------------------------------------------------------------------
# Usage:
#   Run directly on a Proxmox VE node:
#     bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/scrutiny.sh)"
#
...
APP_NAME="Scrutiny"
SCRIPT_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/scrutiny.sh"
SCRIPT_PAGE="https://community-scripts.org/scripts/scrutiny"
