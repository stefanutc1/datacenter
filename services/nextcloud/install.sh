...
# Source:      https://community-scripts.org/scripts/nextcloud
...
APP_NAME="Nextcloud"
SCRIPT_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/nextcloud.sh"
SCRIPT_PAGE="https://community-scripts.org/scripts/nextcloud"
