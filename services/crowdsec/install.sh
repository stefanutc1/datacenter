...
# Source:      https://community-scripts.org/scripts/crowdsec
...
APP_NAME="CrowdSec"
SCRIPT_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/crowdsec.sh"
SCRIPT_PAGE="https://community-scripts.org/scripts/crowdsec"
