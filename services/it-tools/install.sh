...
# Source:      https://community-scripts.org/scripts/it-tools
# Repository:  https://github.com/community-scripts/ProxmoxVE
# License:     MIT
# ---------------------------------------------------------------------------
# Usage:
#   Run directly on a Proxmox VE node:
#     bash -c "$(curl -fsSL https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/it-tools.sh)"
#
...
APP_NAME="IT Tools"
SCRIPT_URL="https://raw.githubusercontent.com/community-scripts/ProxmoxVE/main/ct/it-tools.sh"
SCRIPT_PAGE="https://community-scripts.org/scripts/it-tools"
