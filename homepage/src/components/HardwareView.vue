...
.node-card:hover {
  ...
  box-shadow: var(--shadow-lg), 0 0 25px rgba(62, 42, 44, 0.3);
...
.capacity-box {
  background: rgba(207, 161, 106, 0.06);
  border: 1px solid rgba(207, 161, 106, 0.2);
  border-radius: var(--radius-md);
...
.text-amber { color: #cfa16a; }
.text-purple { color: #baa6a8; }
